...
logo=("""\033[38;5;195m
  ...
  M YM   ,M MM   ,6"Yb.    MMpMMMb.  `7MM  `7MMpMMMb.  

  M  Mb  M' MM  8)   MM    MM    MM    MM    MM    MM  

  M  YM.P'  MM   ,pm9MM    MM    MM    MM    MM    MM  

  M  `YM'   MM  8M   MM    MM    MM    MM    MM    MM  

.JML. `'  .JMML.`Moo9^Yo..JMML  JMML..JMML..JMML  JMML.

\033[1;32m-----------------------------------------------------

\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] ADMIN       : Mahin
...
def Subscraption():
    ...
    if key1 in r1:
        ...
        os.system('xdg-open https://wa.me/+8801925798757?text=' + tks) 
...
def beeq(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[38;5;195m[Mahin-XD\033[38;5;195m] %s|OK-\033[38;5;46m%s\r'%(loop,len(ok))),
